...
* [iD](http://www.openstreetmap.org/edit?editor=id) - JavaScript based editor for the web browser with a wide array of presets. ([Source Code](https://github.com/openstreetmap/iD) ⭐ 3,863 | 🐛 1,009 | 🌐 JavaScript | 📅 2026-08-27 / [Wiki](https://wiki.openstreetmap.org/wiki/ID))
...
* [StreetComplete](https://github.com/westnordost/StreetComplete) ⭐ 4,770 | 🐛 132 | 🌐 Kotlin | 📅 2026-08-26 - App for improving OSM by answering simple questions. ([Android](https://play.google.com/store/apps/details?id=de.westnordost.streetcomplete) / [Wiki](https://wiki.openstreetmap.org/wiki/StreetComplete))
...
* [GoMap!!](http://gomaposm.com) - Feature-rich mobile editor for iOS. ([iOS](https://apps.apple.com/app/id592990211) / [Source Code](https://github.com/bryceco/GoMap) ⭐ 412 | 🐛 95 | 🌐 Swift | 📅 2026-08-26 / [Wiki](https://wiki.openstreetmap.org/wiki/Go_Map!!))
* [SCEE](https://github.com/Helium314/SCEE) ⭐ 244 | 🐛 123 | 🌐 Kotlin | 📅 2026-08-23 - StreetComplete Expert Edition: A modified version of StreetComplete that allows advanced editing capabilities. ([Android](https://f-droid.org/packages/de.westnordost.streetcomplete.expert/) / [Wiki](https://wiki.openstreetmap.org/wiki/SCEE))
...
* [opening\_hours evaluation tool](https://openingh.openstreetmap.de/evaluation_tool/) - Tool for evaluating `opening_hours` tags. ([Source Code](https://github.com/opening-hours/opening_hours.js) ⭐ 254 | 🐛 95 | 🌐 JavaScript | 📅 2026-08-26)
...
* [OpenStreetMap Welcome Tool](https://welcome.osm.be/) - Tool for finding fresh mappers in your area. ([Source Code](https://github.com/osmbe/osm-welcome-tool) ⭐ 45 | 🐛 32 | 🌐 PHP | 📅 2026-08-23)
...
* [Baremaps](https://www.baremaps.com/) - Open source pipeline for producing Mapbox vector tiles from OpenStreetMap with Postgis and Java. ([Source Code](https://github.com/baremaps/baremaps) ⚠️ Archived)

### Browser Extensions

* [better-osm-org](https://github.com/deevroman/better-osm-org) ⭐ 184 | 🐛 177 | 🌐 JavaScript | 📅 2026-08-27 - Userscript that adds visualization of changesets and many other useful features to OSM website.
...
* [MapRoulette](https://maproulette.org/) - Various challenges for making small edits to achive big tasks. ([Source Code](https://github.com/osmlab/maproulette3) ⭐ 166 | 🐛 92 | 🌐 JavaScript | 📅 2026-08-26 / [Wiki](https://wiki.openstreetmap.org/wiki/MapRoulette))
...
* [Organic Maps](https://organicmaps.app/) - A free offline maps app based on OSM. (Android, iOS / [Source Code](https://github.com/organicmaps/organicmaps) ⭐ 15,218 | 🐛 3,465 | 🌐 C++ | 📅 2026-08-26 / [Wiki](https://wiki.openstreetmap.org/wiki/Organic_Maps))
* [OsmAnd](https://osmand.net) - Map viewing and navigation (routing) application with offline functionality available for Android and iOS. (Android, iOS / [Source Code Android](https://github.com/osmandapp/OsmAnd) ⭐ 5,932 | 🐛 3,446 | 🌐 Java | 📅 2026-08-27 / [Source Code iOS](https://github.com/osmandapp/OsmAnd-iOS) ⭐ 346 | 🐛 313 | 🌐 Objective-C++ | 📅 2026-08-27 / [Wiki](https://wiki.openstreetmap.org/wiki/OsmAnd))
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,636 | 🐛 141 | 🌐 Rust | 📅 2026-08-23 - Generate cities from real life in Minecraft using Python.
...
* [OSRM](https://github.com/Project-OSRM/osrm-backend) ⭐ 8,014 | 🐛 360 | 🌐 C++ | 📅 2026-08-24 -  Routing engine for use in C++ applications. ([Wiki](https://wiki.openstreetmap.org/wiki/Open_Source_Routing_Machine))
* [mapnik](https://github.com/mapnik/mapnik) ⭐ 3,955 | 🐛 727 | 🌐 C++ | 📅 2026-08-26 - Combines pixel-perfect image output with lightning-fast cartographic algorithms, and exposes interfaces in C++, Python, and Node. ([Wiki](https://wiki.openstreetmap.org/wiki/Mapnik))
* [libosmium](https://github.com/osmcode/libosmium) ⭐ 551 | 🐛 12 | 🌐 C++ | 📅 2026-08-25 - Fast and flexible C++ library for working with OpenStreetMap data. ([Wiki](https://wiki.openstreetmap.org/wiki/Osmium))

### JavaScript

* [Leaflet](https://leafletjs.com/) - An open-source JavaScript library for mobile-friendly interactive maps. ([Source Code](https://github.com/Leaflet/Leaflet) ⭐ 45,525 | 🐛 564 | 🌐 JavaScript | 📅 2026-08-24 / [Wiki](https://wiki.openstreetmap.org/wiki/Leaflet))
* [OpenLayers](https://openlayers.org/) - A high-performance library for rendering raster and vector maps. ([Source Code](https://github.com/openlayers/openlayers) ⭐ 12,556 | 🐛 853 | 🌐 JavaScript | 📅 2026-08-26 / [Wiki](https://wiki.openstreetmap.org/wiki/OpenLayers))
* [MapLibre GL JS](https://maplibre.org/projects/#js) - A map renderer with GPU-accelerated vector tile rendering. ([Source Code](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,463 | 🐛 383 | 🌐 TypeScript | 📅 2026-08-27 / [See Related List](#related-awesome-maplibre))
...
* [osmnx](https://github.com/gboeing/osmnx) ⭐ 5,828 | 🐛 2 | 🌐 Python | 📅 2026-07-31 - Visualizer for street networks. ([Wiki](https://wiki.openstreetmap.org/wiki/OSMnx))
...
* [QuackOSM](https://github.com/kraina-ai/quackosm) ⭐ 375 | 🐛 24 | 🌐 Python | 📅 2026-08-03 - A Python library for downloading, filtering and transforming `*.osm.pbf` files into `GeoParquet` files using DuckDB.
...
* [GraphHopper](https://github.com/graphhopper/graphhopper) ⭐ 6,646 | 🐛 241 | 🌐 Java | 📅 2026-08-27 - Open source route planning library and server using OpenStreetMap. ([Wiki](https://wiki.openstreetmap.org/wiki/GraphHopper))
* [OpenTripPlanner](https://github.com/opentripplanner/OpenTripPlanner) ⭐ 2,723 | 🐛 135 | 🌐 Java | 📅 2026-08-27 - Open source multi-modal trip planner. ([Wiki](https://wiki.openstreetmap.org/wiki/OpenTripPlanner))
...
* [GeoDesk](https://github.com/clarisma/geodesk) ⭐ 193 | 🐛 43 | 🌐 Java | 📅 2026-07-17 - Fast and storage-efficient database for OpenStreetMap analysis.
...
* [awesome-maplibre](https://github.com/maplibre/awesome-maplibre#readme) ⭐ 1,054 | 🐛 0 | 📅 2026-08-27 - A collection of awesome things that use or support MapLibre! <span id="related-awesome-maplibre"/>
