...
* [iD](http://www.openstreetmap.org/edit?editor=id) - JavaScript based editor for the web browser with a wide array of presets. ([Source Code](https://github.com/openstreetmap/iD) ⭐ 3,877 | 🐛 992 | 🌐 JavaScript | 📅 2026-09-16 / [Wiki](https://wiki.openstreetmap.org/wiki/ID))
...
* [Level0](http://level0.osmz.ru/) - Text based editor that's useful in specific corner cases. ([Source Code](https://github.com/zverik/level0) ⭐ 63 | 🐛 31 | 🌐 Motoko | 📅 2026-08-19 / [Wiki](https://wiki.openstreetmap.org/wiki/Level0))
...
* [StreetComplete](https://github.com/westnordost/StreetComplete) ⭐ 4,799 | 🐛 141 | 🌐 Kotlin | 📅 2026-09-16 - App for improving OSM by answering simple questions. ([Android](https://play.google.com/store/apps/details?id=de.westnordost.streetcomplete) / [Wiki](https://wiki.openstreetmap.org/wiki/StreetComplete))
* [Every Door](https://every-door.app) - Android and iOS app that lets you create and edit objects in OpenStreetMap. It supports editing node and polygon features, and creating point features like shops, benches, and building entrances. ([Android](https://play.google.com/store/apps/details?id=info.zverev.ilya.every_door) / [iOS](https://apps.apple.com/app/id1621945342) / [Source Code](https://github.com/zverik/every_door) ⭐ 557 | 🐛 211 | 🌐 Dart | 📅 2026-04-19 / [Wiki](https://wiki.openstreetmap.org/wiki/Every_Door))
* [Vespucci](https://vespucci.io/) - Advanced full-data-model editor for Android. ([Android](https://play.google.com/store/apps/details?id=de.blau.android) / [Source Code](https://github.com/MarcusWolschon/osmeditor4android) ⭐ 473 | 🐛 222 | 🌐 Java | 📅 2026-09-14 / [Wiki](https://wiki.openstreetmap.org/wiki/Vespucci))
* [GoMap!!](http://gomaposm.com) - Feature-rich mobile editor for iOS. ([iOS](https://apps.apple.com/app/id592990211) / [Source Code](https://github.com/bryceco/GoMap) ⭐ 413 | 🐛 88 | 🌐 Swift | 📅 2026-09-16 / [Wiki](https://wiki.openstreetmap.org/wiki/Go_Map!!))
* [SCEE](https://github.com/Helium314/SCEE) ⭐ 249 | 🐛 131 | 🌐 Kotlin | 📅 2026-09-06 - StreetComplete Expert Edition: A modified version of StreetComplete that allows advanced editing capabilities. ([Android](https://f-droid.org/packages/de.westnordost.streetcomplete.expert/) / [Wiki](https://wiki.openstreetmap.org/wiki/SCEE))
...
* [overpass-turbo](http://overpass-turbo.eu) - Web based data mining tool for OpenStreetMap using Overpass API. ([Source Code](https://github.com/tyrasd/overpass-turbo) ⭐ 1,241 | 🐛 258 | 🌐 TypeScript | 📅 2026-07-19 / [Wiki](https://wiki.openstreetmap.org/wiki/Overpass_turbo))
...
* [opening\_hours evaluation tool](https://openingh.openstreetmap.de/evaluation_tool/) - Tool for evaluating `opening_hours` tags. ([Source Code](https://github.com/opening-hours/opening_hours.js) ⭐ 256 | 🐛 95 | 🌐 JavaScript | 📅 2026-09-15)
...
* [OSMTracker](https://github.com/labexp/osmtracker-android) ⭐ 560 | 🐛 95 | 🌐 Java | 📅 2026-05-28 - Offline GPS tracking tool for recording GPX tracks. (Android / [Wiki](https://wiki.openstreetmap.org/wiki/OSMTracker_\(Android\)))
...
* [better-osm-org](https://github.com/deevroman/better-osm-org) ⭐ 189 | 🐛 174 | 🌐 JavaScript | 📅 2026-09-16 - Userscript that adds visualization of changesets and many other useful features to OSM website.
...
* [latest-changes](https://rene78.github.io/latest-changes/#2/15.0/-15.0) - Visualize latest OSM changesets within a certain geographic boundary. Includes a simple vandalism checker. ([Source Code](https://github.com/rene78/latest-changes/) ⭐ 12 | 🐛 5 | 🌐 JavaScript | 📅 2026-03-17)
...
* [MapRoulette](https://maproulette.org/) - Various challenges for making small edits to achive big tasks. ([Source Code](https://github.com/osmlab/maproulette3) ⭐ 167 | 🐛 95 | 🌐 JavaScript | 📅 2026-09-16 / [Wiki](https://wiki.openstreetmap.org/wiki/MapRoulette))
* [NotesReview](https://ent8r.github.io/NotesReview/) - Interface for searching and resolving OSM notes. ([Source Code](https://github.com/ENT8R/NotesReview) ⭐ 53 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-02)
...
* [Streets GL](https://github.com/StrandedKitty/streets-gl) ⭐ 1,092 | 🐛 106 | 🌐 TypeScript | 📅 2025-08-21 - OpenStreetMap 3D renderer powered by WebGL2. ([Wiki](https://wiki.openstreetmap.org/wiki/Streets_GL))
...
* [Organic Maps](https://organicmaps.app/) - A free offline maps app based on OSM. (Android, iOS / [Source Code](https://github.com/organicmaps/organicmaps) ⭐ 15,435 | 🐛 3,518 | 🌐 C++ | 📅 2026-09-16 / [Wiki](https://wiki.openstreetmap.org/wiki/Organic_Maps))
* [OsmAnd](https://osmand.net) - Map viewing and navigation (routing) application with offline functionality available for Android and iOS. (Android, iOS / [Source Code Android](https://github.com/osmandapp/OsmAnd) ⭐ 6,017 | 🐛 3,526 | 🌐 Java | 📅 2026-09-17 / [Source Code iOS](https://github.com/osmandapp/OsmAnd-iOS) ⭐ 351 | 🐛 328 | 🌐 Objective-C++ | 📅 2026-09-16 / [Wiki](https://wiki.openstreetmap.org/wiki/OsmAnd))
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,965 | 🐛 127 | 🌐 Rust | 📅 2026-09-14 - Generate cities from real life in Minecraft using Python.
...
* [OSRM](https://github.com/Project-OSRM/osrm-backend) ⭐ 8,080 | 🐛 359 | 🌐 C++ | 📅 2026-09-13 -  Routing engine for use in C++ applications. ([Wiki](https://wiki.openstreetmap.org/wiki/Open_Source_Routing_Machine))
...
* [Leaflet](https://leafletjs.com/) - An open-source JavaScript library for mobile-friendly interactive maps. ([Source Code](https://github.com/Leaflet/Leaflet) ⭐ 45,626 | 🐛 576 | 🌐 JavaScript | 📅 2026-09-14 / [Wiki](https://wiki.openstreetmap.org/wiki/Leaflet))
* [OpenLayers](https://openlayers.org/) - A high-performance library for rendering raster and vector maps. ([Source Code](https://github.com/openlayers/openlayers) ⭐ 12,577 | 🐛 851 | 🌐 JavaScript | 📅 2026-09-16 / [Wiki](https://wiki.openstreetmap.org/wiki/OpenLayers))
* [MapLibre GL JS](https://maplibre.org/projects/#js) - A map renderer with GPU-accelerated vector tile rendering. ([Source Code](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,670 | 🐛 275 | 🌐 TypeScript | 📅 2026-09-16 / [See Related List](#related-awesome-maplibre))
...
* [osmnx](https://github.com/gboeing/osmnx) ⭐ 5,844 | 🐛 3 | 🌐 Python | 📅 2026-07-31 - Visualizer for street networks. ([Wiki](https://wiki.openstreetmap.org/wiki/OSMnx))
* [prettymapp](https://github.com/chrieke/prettymapp) ⭐ 2,819 | 🐛 4 | 🌐 Python | 📅 2026-07-08 - Create beautiful maps from OpenStreetMap data.
...
* [QuackOSM](https://github.com/kraina-ai/quackosm) ⭐ 375 | 🐛 23 | 🌐 Python | 📅 2026-09-15 - A Python library for downloading, filtering and transforming `*.osm.pbf` files into `GeoParquet` files using DuckDB.
...
* [GraphHopper](https://github.com/graphhopper/graphhopper) ⭐ 6,694 | 🐛 242 | 🌐 Java | 📅 2026-09-16 - Open source route planning library and server using OpenStreetMap. ([Wiki](https://wiki.openstreetmap.org/wiki/GraphHopper))
* [OpenTripPlanner](https://github.com/opentripplanner/OpenTripPlanner) ⭐ 2,740 | 🐛 145 | 🌐 Java | 📅 2026-09-17 - Open source multi-modal trip planner. ([Wiki](https://wiki.openstreetmap.org/wiki/OpenTripPlanner))
...
* [overpass](http://overpass-api.de) - Read-only API that serves up custom selected parts of the OSM map data. ([Source Code](https://github.com/drolbr/Overpass-API) ⭐ 923 | 🐛 220 | 🌐 C++ | 📅 2026-02-19 / [Wiki](https://wiki.openstreetmap.org/wiki/Overpass_API))
...
* [awesome-maplibre](https://github.com/maplibre/awesome-maplibre#readme) ⭐ 1,077 | 🐛 0 | 📅 2026-09-14 - A collection of awesome things that use or support MapLibre! <span id="related-awesome-maplibre"/>
